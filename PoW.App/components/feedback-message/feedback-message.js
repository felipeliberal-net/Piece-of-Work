(function(angular) {
    ...
    var feedbackMessage = angular.module('feedback-message');

    feedbackMessage.directive('growl', [function() {
        return {
            restrict: 'A',
    ...
    feedbackMessage.provider('growl', function() {
        var _ttl = {
            success: null,
            error: null,
            warning: null,
    ...
    feedbackMessage.service('growlMessages', [
      '$sce',
      '$interval',
